...
public class ListActividad11CabreraFuentesData {
	...
	public void listTestData() throws PersistentException {
		...
		int length = Math.min(diagramaclasesbdLista_De_Reproduccions.length, ROW_COUNT);
		...
		length = Math.min(diagramaclasesbdCategorias.length, ROW_COUNT);
		for (int i = 0; i < length; i++) {
	...
	public void listByCriteria() throws PersistentException {
		...
		int length =diagramaclasesbdLista_De_Reproduccions== null ? 0 : Math.min(diagramaclasesbdLista_De_Reproduccions.length, ROW_COUNT); 
		for (int i = 0; i < length; i++) {
			 System.out.println(diagramaclasesbdLista_De_Reproduccions[i]);
		}
		...
		length =diagramaclasesbdCategorias== null ? 0 : Math.min(diagramaclasesbdCategorias.length, ROW_COUNT); 
		for (int i = 0; i < length; i++) {
			 System.out.println(diagramaclasesbdCategorias[i]);
		}
