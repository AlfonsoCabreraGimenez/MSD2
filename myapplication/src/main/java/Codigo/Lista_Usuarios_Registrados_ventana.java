...
public class Lista_Usuarios_Registrados_ventana extends VerticalLayout {
	...
	protected HorizontalLayout hBuscar;
	protected TextField buscar;
	protected Button botonBuscar;
	protected HorizontalLayout husuarios;

	public Lista_Usuarios_Registrados_ventana() {
		Design.read(this);
	}
}
