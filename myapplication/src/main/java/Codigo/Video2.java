public class Video2 {
	...
	public boolean videoPropio(TipoUsuario aUsuario) {
		throw new UnsupportedOperationException();
	}

	public boolean perfilPropio(TipoUsuario aUsuario) {
		throw new UnsupportedOperationException();
	}

	public void accedePagVideoPropio(Object aVisualizacion_Video_PropioAR) {
		throw new UnsupportedOperationException();
	}

	public void accedePagVideoAjeno(Object aVisualizacion_Video_Ajeno) {
		throw new UnsupportedOperationException();
	}

	public void accedePagPerfilPropio(Object aPerfil_Propio_A) {
		throw new UnsupportedOperationException();
	}

	public void accedePagPerfilAjeno(Object aPerfil_Ajeno_R) {
		throw new UnsupportedOperationException();
	}
}