...
public class Actividad11CabreraFuentesPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Actividad11CabreraFuentes";
	...
	private Actividad11CabreraFuentesPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new Actividad11CabreraFuentesPersistentManager();
		}
