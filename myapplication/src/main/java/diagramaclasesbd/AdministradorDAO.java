...
public class AdministradorDAO {
	...
	public static boolean deleteAndDissociate(diagramaclasesbd.Administrador administrador)throws PersistentException {
		try {
			...
			diagramaclasesbd.Lista_De_Reproduccion[] lProp_des = administrador.prop_de.toArray();
			...
			diagramaclasesbd.Video[] lProp_video_des = administrador.prop_video_de.toArray();
